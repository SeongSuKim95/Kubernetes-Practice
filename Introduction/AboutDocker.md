# Docker 이해하기 : Virtual Machine에서 Process 격리까지
...
![Virtual Machine 구조](../images/Introduction/2.1_Virtual_Machine.png)

Virtual Machine 구조는 네 개의 계층으로 나뉩니다.

1) Hardware : 실제 물리 자원입니다. (CPU, Memory, Disk)
2) Hypervisor : 하드웨어 위에서 여러 VM을 생성하고 자원을 분배합니다.
3) Guest OS : 각 VM 안에 설치되는 독립적인 운영체제입니다.
4) Application : Guest OS 위에서 실행되는 실제 서비스입니다.

## 2.2 VM의 핵심 특징

- VM은 **OS 단위** 가상화이다.
- VM이 여러 개라면 OS도 여러 개이며,각 **VM은 독립적인 Kernel**을 가진다.
- 이 구조는 강력한 격리를 제공하지만, 동시에 무겁다.

# 3. VM 이후에도 남아 있던 문제

VM은 자원 문제를 해결했지만, 또 다른 문제가 남아 있었습니다.
> “내 컴퓨터에서는 application이 잘 동작하는데, 왜 다른 서버에서는 안 되지?”
...
<p align="center">
  <img src="../images/Introduction/4.2_Docker_Container_1.png" alt="Docker 컨테이너 구조 1" width="48%" />
  <img src="../images/Introduction/4.2_Docker_Container_2.png" alt="Docker 컨테이너 구조 2" width="48%" />
</p>
...
<p align="center">
  <img src="../images/Introduction/7.1_Container_Isolation.png" alt="Container 격리 구조" width="48%" />
  <img src="../images/Introduction/7.1_Cgroups.png" alt="Cgroups 구조" width="48%" />
</p>
...
![Image와 Container 구조도](../images/Introduction/8.1_Image_and_Container.png)
