...
> 15주 연재의 첫 글입니다. 이번 주는 Kubernetes 명령을 외우기보다, 기술이 왜 이런 순서로 쌓여 왔는지를 정리하고, Docker로 컨테이너를 운용할 때 사람이 직접 반복하는 작업을 겪어 봅니다. Docker를 처음 듣는 분도 따라올 수 있도록, 컨테이너가 무엇인지부터 풀어 씁니다.
...
![Bare Metal 구조](../images/articles/01/02-physical-server.svg)
...
![Docker 공식 로고](../images/articles/01/29-docker-official-logo.svg)
...
![Docker Compose 공식 로고](../images/articles/01/30-compose-official-logo.svg)
...
![오케스트레이션이 필요한 이유](../images/articles/01/32-why-orchestration.svg)
...
![Docker Swarm 아이콘](../images/articles/01/31-swarm-official-logo.svg)
