...
![Deployment가 ReplicaSet을 통해 Pod 템플릿을 교체하는 과정](../images/articles/03/09-deployment-replicaset-update.svg)
...
![웹 서버와 데이터베이스 사례로 비교하는 Deployment와 StatefulSet](../images/articles/03/10-deployment-vs-statefulset-scenarios.svg)
...
![ReplicaSet의 애플리케이션 Pod와 Node마다 실행되는 DaemonSet Pod](../images/articles/03/11-daemonset-node-agents.svg)
