...
![Docker 계열과 Kubernetes](../images/articles/02/21-docker-tools-vs-k8s.svg)
...
<img src="../images/characters/character-pod.png" alt="성수선임과 함께 배우는 쿠버네티스 : Pod 캐릭터" width="40%" />
...
<img src="../images/characters/character-node.png" alt="성수선임과 함께 배우는 쿠버네티스 : Node 캐릭터" width="40%" />
